...
const projects = [
    {
      ...
      description:
        "A review of Digital Twins for security testing and threat prediction for MLO exploits in Wi-Fi 7.",
    ...
    },
    {
      ...
      description:
        "A system to modernize and streamline the university canteen experience using IoT and other technologies.",
    ...
    },
    {
      ...
      description:
        "A machine learning project to predict the probability of heart failure in cardiac patients.",
    ...
    },
    {
      ...
      description:
        "A neural network-based system to analyze historical data and predict future stock market behavior.",
    ...
    },
    {
      ...
      description:
        "A computer vision project to remove diverse weather effects from images, significantly improving output quality.",
